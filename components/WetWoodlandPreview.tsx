  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      const flyoverPoints: FlyOverPoint[] = [
        ...
        { longitude: -3.2, latitude: 51.3, zoom: 12.5, duration: 5000 },
        { longitude: -2.4, latitude: 51.8, zoom: 12.5, duration: 5000 },
        { longitude: -3.8, latitude: 50.7, zoom: 12.5, duration: 5000 },
      ];
