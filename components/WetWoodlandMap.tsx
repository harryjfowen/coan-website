...
export default function WetWoodlandMap() {
  ...
  useEffect(() => {
    ...
    async function init() {
      const [maplibre, { MapboxOverlay }, { BitmapLayer }, { TileLayer }, { fromUrl }] = await Promise.all([
        import("maplibre-gl"),
        import("@deck.gl/mapbox") as any,
      ...
      map.on("load", async () => {
        ...
        const overlay = new MapboxOverlay({ layers: [cogLayer] });
