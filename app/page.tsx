    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-xs font-medium tracking-widest uppercase mb-6" style={{ color: "#2D7DD2" }}>
          ...
          <div className="flex gap-4 mb-16">
            <a href="/research" className="text-sm font-medium text-white px-5 py-2.5 transition-colors" style={{ backgroundColor: "#2D7DD2" }}>
              View research
            </a>
            <a href="/consultancy" className="text-sm font-medium px-5 py-2.5 border transition-colors" style={{ color: "#2D7DD2", borderColor: "#2D7DD2" }}>
              Work with us
            </a>
          </div>
            ...
            {featuredProjects.map((project) => (
              ...
              >
                ...
                <div className="px-5 pb-6 pt-3 flex flex-col flex-1">
                  ...
                  <span className="inline-block text-xs font-medium text-white px-3 py-1.5 rounded-full transition-colors self-start" style={{ backgroundColor: "#2D7DD2" }}>
                    Explore →
                  </span>
                </div>
              </a>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-100">
            {sectors.map((s) => (
              <a key={s.title} href="/consultancy" className="group bg-white p-8 hover:bg-gray-50 transition-colors">
                <h3 className="text-sm font-semibold mb-3 transition-colors" style={{ color: "#2D7DD2" }}>{s.title}</h3>
