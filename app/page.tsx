      ...
      <section className="pt-32 pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex gap-4 mb-16">
            <a href="/research" className="text-sm font-medium text-white px-5 py-2.5 transition-colors" style={{ backgroundColor: "#0D9488" }}>
              View research
            </a>
            <a href="/consultancy" className="text-sm font-medium px-5 py-2.5 border transition-colors" style={{ color: "#0D9488", borderColor: "#0D9488" }}>
              Work with us
            </a>
          </div>
